package cn.goldlone.job_analysis.analysis.etl.utils

import java.text.DecimalFormat

import cn.goldlone.graduation.constant.{JobLabel, JobPrimaryType}
import cn.goldlone.job_analysis.analysis.constant.{JobPrimaryType, JobSubType}
