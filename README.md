...
> * 海量非结构化网络招聘数据的挖掘分析
>
> * https://blog.csdn.net/Analyst128/article/details/82229241
...
* 维度：
  * 岗位名称、招聘时间（xx不限）、工作地点（xx不限）、学历（xx不限）、是否实习生
* KPI：
  * 数量、最低工资、最高工资、平均工资、不同薪资区间的岗位数量（0, 5, 10, 15, 20, 25, 30, 以上）
...
选择某个岗位（根据是否实习分别做一套报表）

* 折线图：时间为横轴，数量为纵轴，反应岗位需求量变化
* 柱状图：不同工作地点所在比例（由高到低）
* 柱状图：不同工作经验
* 柱转图：不同薪资阶段
* 饼图：不同学历所占比例
